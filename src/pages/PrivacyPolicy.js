          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-10">
              <section className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
                <h2 className="text-2xl font-semibold text-teal-400 mb-4">1. Information We Collect</h2>
                <p className="text-gray-300 mb-4">We may collect the following types of information:</p>
                <ul className="list-disc pl-6 text-gray-300 space-y-2">
                  <li><span className="text-teal-400">Personal Information:</span> Name, email address, phone number, company details, and other contact details provided during inquiries or bookings.</li>
                  <li><span className="text-teal-400">Payment Information:</span> Billing details for transactions related to our coworking services.</li>
                  <li><span className="text-teal-400">Usage Data:</span> Information about how you interact with our website, such as IP address, browser type, device details, and pages visited.</li>
                  <li><span className="text-teal-400">Other Information:</span> Details shared voluntarily, such as feedback, surveys, or inquiries.</li>
                </ul>
              </section>

              <section className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
                <h2 className="text-2xl font-semibold text-teal-400 mb-4">2. How We Use Your Information</h2>
                <p className="text-gray-300 mb-4">We use the information collected to:</p>
                <ul className="list-disc pl-6 text-gray-300 space-y-2">
              ...
              <section className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
                <h2 className="text-2xl font-semibold text-teal-400 mb-4">3. Sharing Your Information</h2>
                <p className="text-gray-300 mb-4">We respect your privacy and do not sell, rent, or trade your personal information. However, we may share your information with trusted third parties for purposes such as:</p>
                <ul className="list-disc pl-6 text-gray-300 space-y-2">
              ...
              <section className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
                <h2 className="text-2xl font-semibold text-teal-400 mb-4">4. Cookies and Tracking Technologies</h2>
                <p className="text-gray-300 mb-4">Our website uses cookies to enhance your browsing experience. Cookies are small files stored on your device to help us analyze website traffic and understand user preferences.</p>
                <ul className="list-disc pl-6 text-gray-300 space-y-2">
              ...
              <section className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
                <h2 className="text-2xl font-semibold text-teal-400 mb-4">6. Third-Party Links</h2>
                <p className="text-gray-300">
              ...
              <section className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
                <h2 className="text-2xl font-semibold text-teal-400 mb-4">7. Your Rights</h2>
              ...
              <section className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
                <h2 className="text-2xl font-semibold text-teal-400 mb-4">8. Changes to This Policy</h2>
                <p className="text-gray-300">
              ...
              <section className="bg-white/5 rounded-xl p-6 backdrop-blur-sm">
                <h2 className="text-2xl font-semibold text-teal-400 mb-4">9. Contact Us</h2>
                <p className="text-gray-300">
