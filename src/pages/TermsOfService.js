        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">You agree to use our services only for lawful purposes and in accordance with these Terms. You shall not:</p>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">For services requiring payment:</p>
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
