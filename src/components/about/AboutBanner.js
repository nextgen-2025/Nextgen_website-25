...
const AboutBanner = () => {
  return (
    <div className="flex justify-center relative overflow-hidden w-full min-h-[500px] md:h-screen bg-gradient-to-r from-gray-900 to-gray-800">
      <div className="text-white flex flex-col justify-center items-center mx-auto py-10 md:py-0 md:mt-0 max-w-7xl px-3 sm:px-4">
        ...
        <p className="text-gray-300 text-base sm:text-xl mb-6 sm:mb-10 mx-auto px-2 sm:px-20 leading-relaxed text-center">
