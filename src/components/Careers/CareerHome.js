...
const CareerHome = () => {
  return (
    <div className="p-4">
      <div className="flex flex-col md:items-start md:mx-20 mx-4 mt-10">
        <h1 className="text-3xl md:text-4xl font-bold text-teal-400 text-center md:text-left">
          Join Our Team
        </h1>
        <p className="text-base md:text-lg text-white mb-6 py-2  text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start">
          <span>
            <h2 className="text-xl md:text-2xl font-semibold text-teal-400 text-center md:text-left mb-2 font-lato">
              Send Us Your CV
            </h2>
          </span>
