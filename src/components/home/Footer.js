          ...
          <div className="space-y-6 text-left">
            ...
            <ul className="space-y-4">
              {[
                ...
                { name: "Leadership Team", href: "/leaderships" },
          ...
          <div className="space-y-6 text-left">
            ...
            <div className="space-y-4 text-left">
              ...
              >
                ...
                <span className="transform group-hover:translate-x-1 transition-transform duration-300">Chat with us</span>
              </a>
              <a
                href="tel:9930365555"
                className="inline-flex items-center space-x-2 text-gray-300 hover:text-teal-400 transition-colors duration-300"
              >
                ...
                <span className="transform group-hover:translate-x-1 transition-transform duration-300">+91 9930365555</span>
              </a>
            </div>
          </div>
